...
- BP capture: share the Premier window once; **Extract requires Current Rx + Past history** (or Whole window). Patient banner alone is blocked. Vision OCR merges all frames (`prompts/ehr-bp.md`, `BpScreenCapture.tsx`).
